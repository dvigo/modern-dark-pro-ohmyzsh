...
echo "  # Choose theme style: 'standard' (default) or 'capsule'"
echo "  export MODERN_DARK_PRO_STYLE=\"standard\""
echo ""
echo "  # Choose color variant: 'night' (default) or 'monokai'"
echo "  export MODERN_DARK_PRO_VARIANT=\"night\""
echo ""
echo "  # Choose prompt layout: 'classic' (default for standard), 'two-line' (default for capsule), or 'single'"
echo "  export MODERN_DARK_PRO_PROMPT_LAYOUT=\"classic\""
echo ""
echo "  # Enable developer icons/Nerd Fonts (default: false for standard, true for capsule)"
